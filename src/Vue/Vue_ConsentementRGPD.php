    ...
    function donneTexte(): string
    {
        $str = "
            <div style='max-width: 800px; margin: 0 auto; padding: 20px; border: 1px solid #ddd;'>
                <h1 style='text-align: center;'>Objet du traitement (finalité et base légale)</h1>
                
                <div style='border-radius:10px;max-height: 300px; overflow-y: scroll; border: 3px solid #ddd; padding-bottom: 10px; margin-bottom: 10px;'>
                    <p>
                ...
                <div style='padding: 10px; display: flex;'>
                    <form method='get' action='' style='display:flex; flex: 1 1'>
                        <input type='hidden' name='case' value='Gerer_monCompte'>
                        <button type='submit' name='action' value='SeDeconnecter' style='background-color: #d9534f; color: #fff; border: none; padding: 10px 15px; margin-right: 10px; cursor: pointer;'>Refuser</button>
                    </form>
                    <form method='get' action='' style='display:flex; flex: 1 1'>
                        <input type='hidden' name='case' value='AccepterRGPD'>
                        <button type='submit' name='action' value='AccepterRGPD' style='background-color: #5cb85c; color: #fff; border: none; padding: 10px 15px; cursor: pointer;'>Accepter</button>
                    </form>
                </div>
            </div>
        ";
